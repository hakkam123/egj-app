...
<head>
    ...
    <title>General Journal {{ $result === 'approved' ? 'Approved' : 'Rejected' }} - GJAS</title>
</head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    <!-- Header -->
                    <tr>
                        <td style="background-color:{{ $result === 'approved' ? '#059669' : '#dc2626' }};padding:24px 32px;">
                            <h1 style="color:#ffffff;margin:0;font-size:20px;">
                                General Journal {{ $result === 'approved' ? 'Approved ✓' : 'Rejected ✗' }}
                            </h1>
                        </td>
                    </tr>
                    <!-- Content -->
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="color:#374151;font-size:14px;margin:0 0 24px;">
                                @if($result === 'approved')
                                    General Journal Anda telah <strong style="color:#059669;">disetujui</strong>.
                                @else
                                    General Journal Anda telah <strong style="color:#dc2626;">ditolak</strong>.
                                @endif
                            </p>
                            ...
                            <table width="100%" cellpadding="8" cellspacing="0" style="background-color:#f9fafb;border-radius:6px;margin-bottom:24px;">
                                ...
                                <tr>
                                    ...
                                    <td style="color:{{ $result === 'approved' ? '#059669' : '#dc2626' }};font-size:14px;font-weight:600;">
                                ...
                                <tr>
                                    ...
                                    <td style="color:#dc2626;font-size:14px;">{{ $notes }}</td>
                                </tr>
                                @endif
                            </table>
                            ...
                            <p style="color:#374151;font-size:14px;margin:0 0 16px;">
                                Silakan perbaiki dokumen dan lakukan resubmit melalui portal:
                            </p>
                            @endif
