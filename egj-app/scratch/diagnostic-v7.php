...
for ($i = 1; $i <= $pageCount; $i++) {
    ...
    foreach ($stampCoords as $level => $sc) {
        ...
        // 11pt font as changed by user
        $htmlTop = '<div style="font-size:11pt; font-family:Arial, sans-serif; text-align:center; width:100%; height:100%; display:flex; flex-direction:column; justify-content:center; align-items:center;">'
            . '<b>Approved</b><br>' . $date . '</div>';
...
$diagPath = Storage::path('diagnostic_v7.pdf');
